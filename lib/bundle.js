...
/***/ function(module, exports, __webpack_require__) {
	...
	var TitleSequence = __webpack_require__(12);
	...
	GameView.prototype.handleDeath = function () {
	  if (this.game.lives > 0) {
	    this.gameDisplay.youDied(this.context, GameView.constants.DEATH_TIME, this.continue.bind(this), this.deaths);
	    this.deaths += 1;
	  } else {
	    this.gameOver();
	  }
	...
	GameView.prototype.gameOver = function () {
	  ...
	  var gameView = this;
	  key("enter", function () {
	    gameView.gameDisplay.clearDisplay(gameView.context);
	    gameView.newGame();
	    return false
	  });
	};
	...
	GameView.prototype.loadTitleSequence = function() {
	  ...
	  if (this.boundStatus !== "titleBindings") {
	    ...
	    key('h', function(){
	      ...
	      console.log("loading how to play");
	      backBindings();
